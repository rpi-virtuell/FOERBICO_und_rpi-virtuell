...
## 1. Metadaten - warum sollte ich mich dafür interessieren?

Ein ernsthaftes Problem was sich OER-Erstellende und OER-Communities stellt ist, wie kann meine Ressource überhaupt gefunden werden? Diese Frage ist keine hypothetische sondern praktisch nachvollziehbar: Man erstellt ein OER verwendet wissen sowie können darauf, zudem man macht sich die Mühe es rechtssicher zu gestalten. Wenn es nach all der Mühe nicht genutzt wird und keine Anwendung findet, fragt man sich, wofür habe ich all das gemacht? Ein Problem liegt nicht an der fehlenden inhaltlichen Qualität der Ressource, sondern an den fehlenden Metadaten. Dieses zu nächst sehr trockene Thema hat eine enorme Bedeutung für OER, denn Metadaten bilden die Grundlage dafür, dass digitale Bildungsressourcen überhaupt gefunden und sinnvoll genutzt werden können. Sie machen ein Material für Suchmaschinen, OER-Repositorien und andere Informationssysteme maschinenlesbar, indem sie beschreiben, was das Material ist, für wen es gedacht ist und unter welchen Bedingungen es genutzt werden darf. 

## 2. Was sind Metadaten überhaupt?

„Einfach ausgedrückt sind Metadaten Daten über Daten" (Krenn & Tiemann 2020, S. 4). Metadaten sind wie ein Personalausweis für digitale Objekte und ermöglichen ihre Identifikation, Auffindbarkeit und Nachnutzung.
...
Beim Eintragen eines OER-Materials werden die Metadaten im Hintergrund von Suchmaschinen und OER-Portalen ausgelesen. Wenn nach Suchende Schlagwörter oder Themen in eine Suchmaske eingeben, dann gleichen die Suchmaschinen diese mit den Metadaten ab. Es werden die wichtigsten Informationen wie bei einem Personalausweis gegengecheckt um passgenaue Ergebnisse zu liefern. Deshalb entscheiden maßgeblich darüber, ob ein Material beispielsweise bei einer Suche nach „Schöpfung“, „Klasse 6“ oder „CC BY“ überhaupt in den Trefferlisten erscheint. 
...
| **creator** | Urheber:in | Dr. Laura Mößle </br> Phillip Angelina|
...
Um die Erstellung von Metadaten zu erleichtern ist der [OERSI-Metadatengenerator](https://oersi.gitlab.io/metadata-form/metadata-generator.html) eine Unterstützung. Denn hierbei werden die wichtigsten Daten erfragt und daraus generiert er ein maschinenlesbare Metadaten zum rauskopieren.
...
Um die verschiedenen Kompetenzen für die Erstellung von OER zu reflektieren, werden diese bewusst in unseren [Qualitätskriterien](https://git.rpi-virtuell.de/Comenius-Institut/FOERBICO_und_rpi-virtuell/src/branch/main/qualitaetskriterien/handreichung-qualitaetskriterien.md) aufgeführt. Denn Material alleine ermöglicht keine Angemessene Bildung. Es ist hilfreich wenn OER neben einer qualitativen inhaltlichen Richtigkeit, auch verschiedene Kompetenzen, sei es methodisch-didaktisch oder auch fachspezifisch beinhaltet.


## 5. Was Metadaten nicht leisten können: Entstehungsbedingungen sichtbar machen

Reicht es also als Maßnahme, einfach immer mehr und immer feinere Metadatenfelder einzuführen? Krenn und Tiemann (2020) begegnen dieser Idee mit Skepsis. Aus ihrer Perspektive sind Metadaten keine objektiven oder neutralen Beschreibungen, sondern soziotechnische Artefakte, die immer in einem bestimmten Entstehungskontext erzeugt werden. Ohne Kenntnis dieses Kontexts bleibt ihre Aussagekraft „nur sehr eingeschränkt“ (Krenn & Tiemann, 2020, S. 19). Wer ein Material nachnutzt, verfügt häufig nicht mehr über das Hintergrundwissen der Person, die es erstellt und verschlagwortet hat. Kategorien oder Schlagwörter erscheinen dann zwar eindeutig, können aber unterschiedlich interpretiert werden. Diese Einsicht gewinnen wir nicht nur aus der Literatur, sondern deckt sich auch mit unseren empirischen Befunden. Material und Ressourcen alleine und kontextlos sichern keine Nutzung. Denn standardisierte Metadaten schaffen deshalb zwar mehr Vergleichbarkeit, sie können den Entstehungskontext eines Materials jedoch nicht vollständig abbilden.
...
Wenn wir beim Bild mit dem Personalausweis bleiben, dann sind die Metadaten die Eckpunkte um ein OER aufzufinden. Die Entstehungsbedingungen bilden eine Kurzbiografie ab, welche diese Daten in einen Kontext nachvollziehbar und verständlich machen.
