...
- Matrix / Element: [Space OERcommunity](https://matrix.to/#/#oercommunity:rpi-virtuell.de)
    - Insbesondere der Raum zu **edufeed und Nostr**: [**OERtR** (OER_transmitted by Relais)](https://matrix.to/#/%23OERTR:rpi-virtuell.de) oder die anderen offenen und öffentlichen Räume wie [OER + KI](https://matrix.to/#/#oer-ki:rpi-virtuell.de) oder [OER Rechtsfragen](https://matrix.to/#/#oer-rechtsfragen:rpi-virtuell.de).
